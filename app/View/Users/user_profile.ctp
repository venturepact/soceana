...
<div class="wrapper_left_section"> 
  ...
  <!--table-->
  <div class="vol_table">
    <div class="section"> <?php echo $this->Form->create('User',array('id'=>'user_profile_update'));?>
      <div class="signup_form">
        <label name="name">Email</label>
        <?php echo $this->Form->input('email_id',array('type'=>'text','div'=>false,'label'=>false,'style'=>'width:250px;','class'=>'text_style'));?> </div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">FIRST NAME</label>
        <?php echo $this->Form->input('first_name',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style'));?> </div>
      <div class="signup_form">
        <label name="name">LAST NAME</label>
        <?php echo $this->Form->input('last_name',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style'));?> </div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">Employer:</label>
        <?php echo $this->Form->input('employer',array('type'=>'select','div'=>false,'label'=>false,'class'=>'text_style','options' => $companies,'empty' => 'Select Company','default' => 'empty','id'=>'employer'));?> <span id='emp_select' style='float: right;'></span> </div>
      <div id='emp_div' class="signup_form" <?php if($this->request->data['User']['employer']==0)echo 'style="display:block;"';else echo 'style="display:none"';?>>
        ...
        <?php echo $this->Form->input('employer_name',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">Address :</label>
        <?php echo $this->Form->input('location',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
      ...
      <div class="signup_form">
        ...
        <?php echo $this->Form->input('phone',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style','placeholder'=>'For eg.  917-555-5555'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="dob">Date of Birth:</label>
        <?php echo $this->Form->input('birth_date',array('type'=>'text','div'=>false,'label'=>false,'class'=>'text_style','placeholder'=>'MM-DD-YYYY','id'=>'dob','readonly'=>'readonly'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
  ...
  <div class="right_section_inner">
    <div class="profile">
      <div class="profile_top">
		...
		?>
        <a href="<?php echo $this->webroot;?>users/user_pic" class="uploads">UPLOAD</a> </div>
      ...
      <div class="sponser_inner"> <span class="sponsors_text">
        ...
        remaining</span><span id='status_loading'></span>
