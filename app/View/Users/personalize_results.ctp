...
<div class="wrapper_left_section">   
  <!--table-->
  <div class="vol_table">
    <div class="section"> <?php echo $this->Form->create('User',array('id'=>'personalize','action'=>'personalize'));?>
      ...
      <div class="result_section">
        ...
        <div class="result_outer">
          ...
          <div class="r_right_section">
            <div class="img_wrapp"> <img src="<?php 
...
//						   echo ;						   
        ...
        <div class="table_footer_white1">
          <div class="next_preview_butt1"> <?php echo $this->Paginator->counter('Showing {:start} to {:end} of {:count} entries');?>,<br/>
            <div style="float:right;"><?php echo $this->Paginator->prev(' < ', array(), null, array('class' => 'prev'));?> <?php echo $this->Paginator->next(' > '  , array(), null, array('class' => 'next'));?> </div>
          </div>
        </div>
      </div>
      <div align="center"> <a href="<?php echo $this->webroot;?>users/personalize">Back</a> </div>
    </div>
  </div>
</div>
