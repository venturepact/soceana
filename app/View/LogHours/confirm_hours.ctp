...
<?php echo $this->Html->script('jquery.validate');?><?php echo $this->Html->script('datepicker/jquery.datepick');?>
...
<div class="wrapper_left_section">
  ...
  <!--table-->
  <div class="vol_table">
    <div class="section"> <?php echo $this->Form->create('LogHour',array('id'=>'verify_loghour'));?>
      <div class="signup_form">
        <label name="name">Email</label>
        <?php echo $this->Form->input('email',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name">Full NAME</label>
        <?php echo $this->Form->input('full_name',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">VOLUNTEER POSITION:</label>
        <?php echo $this->Form->input('position',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name">ORGANIZATION : </label>
        <?php echo $this->Form->input('organization',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name">Address :</label>
        <?php echo $this->Form->input('location',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name">Country :</label>
        <?php echo $this->Form->input('country',array('type'=>'select','div'=>false,'label'=>false,'class'=>'text_style','options' => array(1 =>'United States of America'),'id'=>'country','disabled'=>'disabled'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name">State : </label>
        <?php 
                     echo $this->Form->input('state',array('type'=>'select','div'=>false,'label'=>false,'class'=>'text_style','options' => $states ,'empty' => 'Select State','default' => 'empty','id'=>'state','disabled'=>'disabled'));?>
      </div>
      <div class="clr"></div>
      <div class="signup_form" id='city_placeholder'>
        <label name="name">City :</label>
        <?php 
                                  echo $this->Form->input('city',array('type'=>'select','div'=>false,'label'=>false,'class'=>'text_style','options' => $cities ,'empty' => 'Select City','default' => 'empty','id'=>'city','disabled'=>'disabled'));?>
      </div>
      <div class="mt20"></div>
      <div class="map"> <img src="<?php echo $this->webroot;?>img/map.png" alt="map" /> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">HOURS VOLUNTEERED:</label>
        <?php echo $this->Form->input('hours',array('type'=>'text','div'=>false,'label'=>false,'readonly'=>'readonly','class'=>'text_style'));?> </div>
      <div class="clr"></div>
      <div class="mt20"></div>
      <div class="signup_form">
        <label name="name">DATE:</label>
        <?php echo $this->Form->input('job_date',array('type'=>'text','div'=>false,'label'=>false,'placeholder'=>'YYYY-MM-DD','id'=>'job_date','class'=>'text_style','readonly'=>'readonly'));?> </div>
      <div class="clr"></div>
      <div class="signup_form">
      ...
      <div class="clr"></div>
      <div class="signup_form">
        <label name="name" class="label_size">PHOTOS: </label>
        <ul>
          <?php
					    ...
					    if(sizeof($log_images) > 0){
							...
							foreach($log_images as $log_image){			
								?>
          <li <?php if($j==0)echo 'class="first"';?>><span><img src="<?php echo $this->webroot;?>img/log_hours/<?php echo $log_image['LogHourImage']['picture_url'];?>" width="90" height="90" /></span> </li>
          <?php	
								$j++;							
							}	
          ...
          <li><span><img src="<?php echo $this->webroot;?>img/add.png" /></span>
            <?php								
							...
							?>
          <li class="first"> <span><img src="<?php echo $this->webroot;?>img/add.png" /></span> </li>
          <li><span><img src="<?php echo $this->webroot;?>img/add.png" /></span> </li>
          <li><span><img src="<?php echo $this->webroot;?>img/add.png" /></span> </li>
          <?php
						}
						?>
