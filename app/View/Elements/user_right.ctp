...
<div class="tab_outer_right">
		...
		?></span></div>
				...
				<?php
				 if(($this->params['controller'] == 'pages' && $this->params['action'] == 'display') || ( $this->params['controller'] == 'log_hours' && $this->params['action'] == 'add')){
			     ?>
               ...
               <?php		   	 
					...
					?>
                        <div class="gallery_img<?php echo $i;?>"><a href="javascript:void(0);" title="<?php echo $image['images']['caption'];?>"><img src="<?php echo $this->webroot;?>img/log_hours/<?php echo $image['images']['picture_url'];?>" alt=""  width="100%" style='cursor:default;'  /></a></div>                       
                <?php
					$i++;
					endforeach;
				?>
